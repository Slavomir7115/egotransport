      ...
      <Container>
        <article>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside">
              <li className="mb-2">
                <strong>Kontaktný formulár:</strong> Meno, priezvisko, e-mailová
                adresa, telefónne číslo a podrobnosti o dopyte.
              </li>
              <li className="mb-2">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside">
              ...
              <li className="mb-2">
                <strong>Oprávnený záujem:</strong> Zabezpečenie funkčnosti webu
                a ochrana pred spamom.
              </li>
              <li className="mb-2">
